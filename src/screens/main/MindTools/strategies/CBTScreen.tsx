...
export default function CBTScreen({ navigation, route }: any) {
  ...
  const getConditionDisplayName = (condition: string): string => {
    const conditionKeyMap: { [key: string]: string } = {
      ...
      "loneliness-depression":"Loneliness and Depression",
...
if (condition === "exam-stress-fear-of-failure") {
  try {
    ...
    if (condition === "unrealistic-beauty-standards") {
     ...
     // handle Loneliness & Depression data from comprehensive JSON file for CBT
     if (condition === "loneliness-depression") {
      try {
        ...
        if (!items || !Array.isArray(items)) {
          console.error("No CBT data array found in Loneliness & Depression data");
          return null;
        }
        ...
        console.error("Error loading Loneliness & Depression CBT data:", error);
        return null;
      }
    }

   
    // handle Special Needs data from comprehensive JSON file for CBT
    if (condition === "special-needs") {
      try {
        const data = require(
          "../../../../assets/data/Emotion/Dealing_with_Children_of_Special_Needs_comprehensive_data.json",
        );
        ...
        if (!items || !Array.isArray(items)) {
          console.error("No CBT data array found in Special needs data");
          return null;
        }
        ...
        console.error("Error loading Special needs CBT data:", error);
        return null;
      }
    }

    // handle Good Parenting data from comprehensive JSON file for CBT
    if (condition === "good-parenting") {
      try {
        ...
        if (!items || !Array.isArray(items)) {
          console.error("No CBT data array found in  Good Parenting data");
          return null;
        }
        ...
        console.error("Error loading Good Parenting CBT data:", error);
        return null;
      }
    }

     // handle Anxiety data from comprehensive JSON file for CBT
    ...
    if (condition === "learning-disability") {
      ...
      try {
        ...
        if (!items || !Array.isArray(items)) {
          console.error("No CBT data array found in Sexual Orientation data");
          return null;
        }
        ...
        console.error("Error loading Sexual Orientation CBT data:", error);
        return null;
      }
    }

    // Handle Early Sexual Anxiety CBT data from comprehensive JSON file
    if (condition === "earlySexualAnxiety") {
      try {
        ...
        if (!items || !Array.isArray(items)) {
          console.error("No CBT data array found in Early Sexual Anxiety data");
          return null;
        }
        ...
        console.error("Error loading Early Sexual Anxiety CBT data:", error);
        return null;
      }
    }

      //Emotiaonl sex education
      ...
      try {
        ...
        if (!items || !Array.isArray(items)) {
          console.error("No CBT data array found in Emotiaonl sex education data");
          return null;
        }
        ...
        console.error("Error loading Emotiaonl sex education CBT data:", error);
        return null;
      }
    }
