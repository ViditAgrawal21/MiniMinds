...
export default function SelfRegulationStrategyScreen({ navigation }: any) {
  ...
  const strategyData = {
    ...
    interventions: [
      ...
      },
      {
        ...
        description:
          "Use specific techniques, such as counting to ten or taking a walk, to manage anger and prevent outbursts.",
        xp: 5,
      },
      {
        title: "Positive Self-Talk",
        description:
          "Replace negative or self-critical thoughts with constructive and encouraging inner dialogue.",
        xp: 5,
      },
      {
        title: "Goal Setting and Monitoring",
        description:
          "Set clear, achievable goals for emotional control and track your progress regularly.",
        xp: 5,
      },
      {
        title: "Developing Coping Plans",
        description:
          "Create action plans for how to handle emotionally charged situations before they arise.",
        xp: 5,
      },
      {
        title: "Practicing Accountability",
        description:
          "Take responsibility for your actions and emotions, and reflect on how you can improve your responses in the future.",
        xp: 5,
      },
    ],
  };
  ...
  const handleTaskFrequencySelect = async (frequency: string) => {
    ...
    try {
      ...
      const newIntervention: SavedIntervention = {
        ...
        subtitle: "From Self-regulation EQ Strategies",
        titleTranslations: {
        ...
        subtitleTranslations: {
          en: "From Self-regulation EQ Strategies",
          hi: "From Self-regulation EQ Strategies",
          mr: "From Self-regulation EQ Strategies",
        },
        descriptionTranslations: {
        ...
        tags: ["emotional-intelligence", "self-regulation"],
        ...
        interventionType: "Self-regulation EQ",
      };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.alertBox}>
          ...
          <Text style={styles.alertText}>
            Self-regulation helps you manage emotions effectively. Practice one
            technique at a time until it becomes natural.
          </Text>
        </View>
