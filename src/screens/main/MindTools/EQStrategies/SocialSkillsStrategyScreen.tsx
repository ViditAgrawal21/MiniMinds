...
export default function SocialSkillsStrategyScreen({ navigation }: any) {
  ...
  const strategyData = {
    ...
    interventions: [
      ...
      },
      {
        ...
        description:
          "Regularly practice offering constructive feedback and being open to feedback from others to foster growth and trust.",
        xp: 5,
      },
      {
        title: "Nonverbal Communication Skills",
        description:
          "Work on interpreting and using body language, eye contact, and facial expressions to enhance your interactions.",
        xp: 5,
      },
      {
        title: "Public Speaking Practice",
        description:
          "Engage in public speaking opportunities to build confidence and improve your ability to communicate with groups.",
        xp: 5,
      },
      {
        title: "Social Etiquette Awareness",
        description:
          "Learn and practice appropriate social behaviors for different contexts to navigate social situations more effectively.",
        xp: 5,
      },
      {
        title: "Building Long-term Relationships",
        description:
          "Focus on maintaining and deepening existing relationships through regular check-ins, shared activities, and mutual support.",
        xp: 5,
      },
    ],
  };
  ...
  const handleTaskFrequencySelect = async (frequency: string) => {
    ...
    try {
      ...
      const newIntervention: SavedIntervention = {
        ...
        subtitle: "From Social skills EQ Strategies",
        titleTranslations: {
        ...
        subtitleTranslations: {
          en: "From Social skills EQ Strategies",
          hi: "From Social skills EQ Strategies",
          mr: "From Social skills EQ Strategies",
        },
        descriptionTranslations: {
        ...
        interventionType: "Social skills EQ",
      };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.illustrationContainer}>
          <View style={styles.illustrationBox}>
            <View style={styles.imageContainer}>
              <CustomIcon type="IO" name="people" size={48} color="#8b5cf6" />
              <Text style={styles.imageLabel}>Social skills</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.alertBox}>
          ...
          <Text style={styles.alertText}>
            Social skills help you connect and communicate effectively. Practice
            regularly in real interactions to build confidence.
          </Text>
        </View>
