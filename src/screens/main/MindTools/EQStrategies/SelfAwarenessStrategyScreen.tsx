...
export default function SelfAwarenessStrategyScreen({ navigation }: any) {
  ...
  const strategyData = {
    ...
    interventions: [
      ...
      },
      {
        ...
        description:
          "Seek feedback from colleagues, friends, and family to gain an external perspective on your behavior and emotional responses.",
        xp: 5,
      },
      {
        title: "Strengths and Weaknesses Analysis",
        description:
          "List your strengths and weaknesses honestly, and reflect on how they influence your emotions and actions.",
        xp: 5,
      },
      {
        title: "Emotion Labeling Exercises",
        description:
          "When you feel a strong emotion, pause and try to accurately name it (e.g., 'I feel frustrated,' 'I feel anxious') to increase emotional clarity.",
        xp: 5,
      },
      {
        title: "Trigger Mapping",
        description:
          "Identify situations or people that consistently trigger strong emotions, and map out why these triggers affect you.",
        xp: 5,
      },
      {
        title: "Guided Self-Reflection",
        description:
          "Use structured reflection questions (e.g., 'What did I feel today and why?') to deepen your understanding of your emotional experiences.",
        xp: 5,
      },
      {
        title: "Body Scan Practice",
        description:
          "Regularly scan your body for physical signs of emotion (like tension or relaxation) to connect physical sensations with emotional states.",
        xp: 5,
      },
      {
        title: "Values Clarification",
        description:
          "Clarify your core values and beliefs, and reflect on how they shape your emotional responses and decisions.",
        xp: 5,
      },
      {
        title: "Personal Mission Statement",
        description:
          "Write a personal mission statement that aligns with your values and emotional goals, helping you stay grounded and self-aware in daily life.",
        xp: 5,
      },
    ],
  };
  ...
  const handleTaskFrequencySelect = async (frequency: string) => {
    ...
    try {
      ...
      const newIntervention: SavedIntervention = {
        ...
        subtitle: "From Self-awareness EQ Strategies",
        titleTranslations: {
        ...
        subtitleTranslations: {
          en: "From Self-awareness EQ Strategies",
          hi: "From Self-awareness EQ Strategies",
          mr: "From Self-awareness EQ Strategies",
        },
        descriptionTranslations: {
        ...
        interventionType: "Self-awareness EQ",
      };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.illustrationContainer}>
          <View style={styles.illustrationBox}>
            <View style={styles.imageContainer}>
              <CustomIcon type="IO" name="eye" size={48} color="#8b5cf6" />
              <Text style={styles.imageLabel}>Self-awareness</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.alertBox}>
          ...
          <Text style={styles.alertText}>
            Self-awareness is the foundation of emotional intelligence. Start
            with one strategy and practice it consistently before adding more.
          </Text>
        </View>
