...
export default function MotivationStrategyScreen({ navigation }: any) {
  ...
  const strategyData = {
    ...
    interventions: [
      ...
      },
      {
        ...
        description:
          "Create a system of rewards for yourself when you reach milestones, reinforcing positive behavior and effort.",
        xp: 5,
      },
      {
        title: "Learning from Setbacks",
        description:
          "View failures and setbacks as learning opportunities, analyzing what went wrong and how to improve.",
        xp: 5,
      },
      {
        title: "Connecting with Purpose",
        description:
          "Regularly remind yourself of the bigger purpose behind your work or goals to sustain long-term motivation.",
        xp: 5,
      },
      {
        title: "Seeking Inspiration",
        description:
          "Read books, watch talks, or connect with inspiring people to reignite your passion and drive.",
        xp: 5,
      },
      {
        title: "Building a Support Network",
        description:
          "Surround yourself with supportive and like-minded individuals who encourage and motivate you to achieve your goals.",
        xp: 5,
      },
    ],
  };
  ...
  const handleTaskFrequencySelect = async (frequency: string) => {
    ...
    try {
      ...
      const newIntervention: SavedIntervention = {
        ...
        subtitle: "From Motivation EQ Strategies",
        titleTranslations: {
        ...
        subtitleTranslations: {
          en: "From Motivation EQ Strategies",
          hi: "From Motivation EQ Strategies",
          mr: "From Motivation EQ Strategies",
        },
        descriptionTranslations: {
        ...
        tags: ["emotional-intelligence", "motivation"],
        ...
        interventionType: "Motivation EQ",
      };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.illustrationContainer}>
          <View style={styles.illustrationBox}>
            <View style={styles.imageContainer}>
              <CustomIcon type="IO" name="rocket" size={48} color="#8b5cf6" />
              <Text style={styles.imageLabel}>Motivation</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.alertBox}>
          ...
          <Text style={styles.alertText}>
            Motivation is your inner drive to achieve. Set meaningful goals and
            celebrate progress to maintain your momentum.
          </Text>
        </View>
