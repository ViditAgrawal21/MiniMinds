    ...
    switch (strategyKey) {
      case "commonSuggestions":
        navigation.navigate("CommonSuggestionsScreen", {
          condition: "common-psychological-issues",
        });
        break;
      case "yoga":
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.title}>{t("commonPsychologicalScreen.title")}</Text>
        <Text style={styles.description}>
          {t("commonPsychologicalScreen.description")}
        </Text>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            {t("commonPsychologicalScreen.symptomsTitle")}
          </Text>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("commonPsychologicalScreen.symptoms.sadnessWorry")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("commonPsychologicalScreen.symptoms.sleepAppetiteChanges")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("commonPsychologicalScreen.symptoms.concentrationDifficulty")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("commonPsychologicalScreen.symptoms.lossOfInterest")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("commonPsychologicalScreen.symptoms.physicalSymptoms")}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            {t("commonPsychologicalScreen.supportStrategiesTitle")}
          </Text>

          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t(
                "commonPsychologicalScreen.strategies.commonSuggestions.title",
              )}
            </Text>
            <Text style={styles.strategyDescription}>
              {t(
                "commonPsychologicalScreen.strategies.commonSuggestions.description",
              )}
            </Text>
            <Pressable
            ...
            >
              <Text style={styles.viewStrategyButtonText}>
                {t("commonPsychologicalScreen.viewStrategyButton")}
              </Text>
            </Pressable>
          </View>
          ...
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("commonPsychologicalScreen.strategies.yoga.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("commonPsychologicalScreen.strategies.yoga.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
          ...
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("commonPsychologicalScreen.strategies.relaxation.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("commonPsychologicalScreen.strategies.relaxation.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
          ...
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("commonPsychologicalScreen.strategies.cbt.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("commonPsychologicalScreen.strategies.cbt.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
          ...
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("commonPsychologicalScreen.strategies.rebt.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("commonPsychologicalScreen.strategies.rebt.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
        ...
        <View style={styles.alertBox}>
          ...
          <Text style={styles.alertText}>
            {t("commonPsychologicalScreen.alertText")}
          </Text>
        </View>
