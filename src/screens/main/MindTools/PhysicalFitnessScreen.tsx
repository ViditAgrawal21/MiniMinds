    ...
    switch (strategyKey) {
      case "commonSuggestions":
        navigation.navigate("CommonSuggestionsScreen", {
          condition: "general-physical-fitness",
        });
        break;
      case "yoga":
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.illustrationContainer}>
          <View style={styles.illustrationBox}>
            <View style={styles.imageContainer}>
              <CustomIcon type="IO" name="fitness" size={48} color="#ef4444" />
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            {t("physicalFitness.commonConcerns")}
          </Text>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("physicalFitness.concerns.motivation")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("physicalFitness.concerns.bodyImage")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("physicalFitness.concerns.sedentary")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("physicalFitness.concerns.limitations")}
            </Text>
          </View>
          <View style={styles.symptomItem}>
            <View style={styles.symptomDot} />
            <Text style={styles.symptomText}>
              {t("physicalFitness.concerns.anxiety")}
            </Text>
          </View>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            {t("physicalFitness.supportStrategies")}
          </Text>
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("physicalFitness.strategies.commonSuggestions.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("physicalFitness.strategies.commonSuggestions.description")}
            </Text>
            <Pressable
            ...
            >
              <Text style={styles.viewStrategyButtonText}>
                {t("physicalFitness.viewStrategyButton")}
              </Text>
            </Pressable>
          </View>
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("physicalFitness.strategies.yoga.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("physicalFitness.strategies.yoga.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
          ...
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("physicalFitness.strategies.relaxation.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("physicalFitness.strategies.relaxation.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
          ...
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("physicalFitness.strategies.cbt.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("physicalFitness.strategies.cbt.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
          ...
          <View style={styles.strategyCard}>
            <Text style={styles.strategyTitle}>
              {t("physicalFitness.strategies.rebt.title")}
            </Text>
            <Text style={styles.strategyDescription}>
              {t("physicalFitness.strategies.rebt.description")}
            </Text>
            <Pressable
              style={styles.viewStrategyButton}
        ...
        <View style={styles.alertBox}>
          ...
          <Text style={styles.alertText}>{t("physicalFitness.alertText")}</Text>
        </View>
