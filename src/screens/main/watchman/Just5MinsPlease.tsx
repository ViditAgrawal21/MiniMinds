...
import SetLimitSelector from "@/components/watchmancompo/SetLimitSelector";
...
const Just5MinsPlease = () => {
  const handleStartJourney = () => {
    console.log("Journey started for 'Just 5 mins Please'!");
  };
...
export default Just5MinsPlease;