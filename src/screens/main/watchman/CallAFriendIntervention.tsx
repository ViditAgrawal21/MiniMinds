...
import ListOfFriends from "@/components/watchmancompo/ListOfFriends"; // Import the ListOfFriends component
...
const CallAFriendIntervention = () => {
  const handleStartJourney = () => {
    console.log("Journey started for 'Call a Friend'!");
  };
...
export default CallAFriendIntervention;
