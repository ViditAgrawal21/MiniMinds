...
import AdjustBrightness from "@/components/watchmancompo/AdjustBrightness"; // Import AdjustBrightness component
...
const DecreaseBrightnessIntervention = () => {
  const handleStartJourney = () => {
    console.log("Journey started for 'Decrease Brightness'!");
  };
...
export default DecreaseBrightnessIntervention;
