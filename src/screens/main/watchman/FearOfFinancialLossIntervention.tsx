...
const FearOfFinancialLossIntervention = () => {
  const handleStartJourney = () => {
    console.log("Journey started for 'Fear of Financial Loss'!");
  };
...
export default FearOfFinancialLossIntervention;