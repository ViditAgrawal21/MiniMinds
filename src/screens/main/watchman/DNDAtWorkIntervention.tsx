...
import PickDateAndTimeSlot from "@/components/watchmancompo/PickDateAndTimeSlot";
...
const DNDAtWorkIntervention = () => {
  const handleStartJourney = () => {
    console.log("Journey started for 'DND @ Work'!");
  };
...
export default DNDAtWorkIntervention;