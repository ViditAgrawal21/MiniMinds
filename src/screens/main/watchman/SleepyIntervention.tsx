...
import RecommendedVideos from "@/components/watchmancompo/RecommendedVideos"; // Import RecommendedVideos
...
const SleepyIntervention = () => {
  const handleStartJourney = () => {
    console.log("Journey started for 'Sleepy Intervention'!");
  };
...
export default SleepyIntervention;